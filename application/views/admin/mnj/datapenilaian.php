	...
	<div class="panel-body" id="a">
		<table id="tb_tth" class="table table-striped">
            ...
            <th class="text-center">Kepala</th>
				...
				<tbody>
					<?php $no=1; foreach($listpkms as $rows): ?>
					<tr>
						<td><?= $no++; ?></td>
            ...
            <td><?= $rows->kepala_pkms ?></td>
						...
						<td class="text-center">
							<a href="<?=base_url()?>admin/mnj/datapenilaian/viewdata?id=<?= $rows->id_pkms ?>" class="btn btn-sm btn-info"><i class="fa fa-external-link"></i></a>
						</td>
					</tr>
					<?php endforeach ?>
				</tbody>
