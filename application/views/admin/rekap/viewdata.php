...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table table-hover table-stripe">
			...
			<tbody>
				<?php $ukesA = $this->dataload->ukesRkpA($pkms, $bln, $thn) ?>
				<?php foreach($ukesA as $rowA): ?>
					...
					<?php $ukesB = $this->dataload->ukesRkpB($rowA->idukes_a, $pkms, $bln, $thn) ?>
				...
				<?php $mnjRekap = $this->dataload->mnjRekap($pkms, $bln, $thn) ?>
				...
				<?php $sumMT=0; $rtMT=0; ?>
				<?php $mtRekap = $this->dataload->mtRekap($pkms, $bln, $thn) ?>
